...
# endif
#ifndef OPENSSL_NO_BIGN
     {NID_bign_curve256v1, &_EC_BIGN_256V1.h, 0,
     "BIGN curve over a 256 bit prime field"},
     {NID_bign_curve384v1, &_EC_BIGN_384V1.h, 0,
     "BIGN curve over a 384 bit prime field"},
     {NID_bign_curve512v1, &_EC_BIGN_512V1.h, 0,
     "BIGN curve over a 512 bit prime field"},
#endif
    /* brainpool curves */
